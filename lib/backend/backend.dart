...
import 'schema/gift_record.dart';
...
export 'schema/gift_record.dart';
...
/// Functions to query GiftRecords (as a Stream and as a Future).
Future<int> queryGiftRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      GiftRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<GiftRecord>> queryGiftRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      GiftRecord.collection,
      GiftRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<GiftRecord>> queryGiftRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
