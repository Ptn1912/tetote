...
import 'chon_nhom_model.dart';
export 'chon_nhom_model.dart';

class ChonNhomWidget extends StatefulWidget {
  const ChonNhomWidget({super.key});
...
class _ChonNhomWidgetState extends State<ChonNhomWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChonNhomModel());
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(40.0),
                                  child: Image.network(
                                    'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/tetote-6hv44f/assets/qzbpfqhhtjmp/ducu3.jpg',
                                    width: 60.0,
                                    height: 60.0,
                                    fit: BoxFit.cover,
                                  ),
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipRRect(
                                  borderRadius: BorderRadius.circular(40.0),
                                  child: Image.network(
                                    'https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/tetote-6hv44f/assets/4c0j10ys7dof/sach1.jpg',
                                    width: 60.0,
                                    height: 60.0,
                                    fit: BoxFit.cover,
                                  ),
